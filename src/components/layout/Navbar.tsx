...
export default function Navbar() {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-40 transition-all duration-300 bg-surface-800 md:bg-transparent ${
        scrolled
          ? 'md:bg-surface-800/95 md:backdrop-blur-md shadow-lg'
          : ''
      }`}
    >
