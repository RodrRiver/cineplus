...
export default function MoviesPage() {
  const { movies: nowPlaying, loading: loadingMovies } = useMovies('now_playing');
  ...
  const baseMovies = searchQuery.trim() ? searchResults : nowPlaying;
    ...
    <div className="min-h-screen bg-surface-900">
      <Container className="pt-24 pb-12">
        ...
        <p className="text-text-secondary mb-6">
          Descubre las películas en pantalla ahora mismo
        </p>
